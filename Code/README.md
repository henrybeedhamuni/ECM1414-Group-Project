...
│ │ └── Activity.py
│ ├── README.md
│ ├── algorithms **All of the different algorithm implementations are in here**
│ │ ├── brute_force.py
│ │ ├── dynamic.py
│ │ ├── dynamic_enhanced.py
│ │ ├── enhanced_brute_force.py
│ │ └── greedy_heuristic.py
│ ├── event_planner.py **Main file**
│ ├── performance_analysis.py **Runs performance tests on all algorithms**
│ └── utils
│ └── read_input_file.py **Reads and parses the input files into python**
├── Documents
...
- 2 methods:
  - Method 1:
    ...
    - Use the python command to run the main file in the terminal:
      `python event_planner.py ../Input_Files/input_small.txt` and you can change the route to the input file in that command. If no input file is specified the default is small.
...
- Tested on M4 MacBook Air RAM:16GB, Storage:16GB
  ...
  - Environment details:
    ...
                     solver : classic
           virtual packages : **archspec=1=m1
                              **conda=26.1.0=0
                              **osx=26.3=0
                              **unix=0=0
